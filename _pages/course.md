...
*  **Programming for Everybody (Python Specialization) [Coursera]**
   
    - This is an introductory level course dedicated for Python Programming Language offered by *University of Michigan (UoM)*. The course comprises of 5 modules. I successfully completed 3 of them.
...
*  **AI for Design and Optimization [Coursera]**
