...
<div style="max-width: 800px; margin: 10px; text-align: justify; font-size:16px;">
  <h3>1. Bangladesh University of Engineering and Technology (BUET), Dhaka</h3>
  <ul>
    <li>Degree: <strong>Bachelor of Science in Mechanical Engineering</strong>
    </li>
    <li>Major: <em>Nuclear Engineering</em>
    </li>
    <li>Result: GPA 0.0 (out of 4.0)</li>
    <li>Year: 2012 - 2017</li>
  </ul>
  <h3>2. Chattogram College</h3>
  <ul>
    <li>Degree: <strong>Higher Secondary School Certificate</strong>
    </li>
    <li>Major: <em>Science</em>
    </li>
    <li>Result: GPA 5.0 (out of 5.0)</li>
    <li>Year: 2009 - 2011</li>
  </ul>
  <h3>3. Ispahani Public School and College, Chattogram</h3>
  <ul>
    <li>Degree: <strong>Secondary School Certificate</strong>
    </li>
    <li>Major: <em>Science</em>
    </li>
    <li>Result: GPA 5.0 (out of 5.0)</li>
  ...
  <ol>
    <li>
      <strong>GRE (General Test)</strong>
      <br>
  ...
  <ol>
    ...
    <li>
      <strong>Introduction to Additive Manufacturing Process</strong> - <em>Arizona State University</em>
    </li>
    <li>
